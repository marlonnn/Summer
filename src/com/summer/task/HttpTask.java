...
public class HttpTask<T> extends BaseTaskObject{
	 ...
	 * @param url
	 */
	public HttpTask(String content, String url)
	{
		super();
	 ...
	 * @param url
	 */
	public HttpTask(List<NameValuePair> params, String url)
	{
		super();
		this.params = params;
		this.url = url;
	...
	public HttpTask(int threadPoolType, String threadTaskName)
	{
	 ...
	 * @param url
	 */
	public HttpTask(int threadPoolType, String threadTaskName, String url)
	{
		super(threadPoolType, threadTaskName);
		this.isUsePostType = false;
		result = new HashMap<String, Object>();
	 ...
	 * @param url
	 */
	public HttpTask(int threadPoolType, String threadTaskName, List<NameValuePair> params, String url)
	{
		super(threadPoolType, threadTaskName);
		this.params = params;
		this.url = url;
	 ...
	 * @param url
	 */
	public HttpTask(int threadPoolType, String threadTaskName, String content, String url)
	{
		super(threadPoolType, threadTaskName);
		this.content = content;
		this.url = url;
